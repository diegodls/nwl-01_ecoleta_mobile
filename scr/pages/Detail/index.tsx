...
import { View, Text, StyleSheet, StatusBar, TouchableWithoutFeedback, Image, SafeAreaView, Linking } from 'react-native';
...
const Detail = () => {
  ...
  if (!data.point) {// caso não tenha informações, mostrar o "loading" ou erro
    return null;
  }
